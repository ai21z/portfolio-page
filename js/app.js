...
function ensureSectionModule(sectionName) {
  if (sectionName === 'blog' && !blogNetworkModulePromise) {
    blogNetworkModulePromise = import('./blog-network-webgl.js?v=20260628').catch((err) => {
  ...
  if (sectionName === 'work' && !workGlobeModulePromise) {
    workGlobeModulePromise = import('./work-globe-webgl.js?v=20260628').catch((err) => {
  ...
  if (sectionName === 'work' && !workTimelineModulePromise) {
    workTimelineModulePromise = import('./work-timeline.js?v=20260628')
